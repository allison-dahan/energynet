			...
			<form class="contact-form" method="post" action="">
				...
				<div class="contact-form__field">
					...
					<select class="contact-form__select" id="qf-request" name="qf_request">
						<option value="" disabled selected><?php esc_html_e( 'Select request type', 'energynet' ); ?></option>
				...
				<div class="contact-form__field">
					<label class="contact-form__label" for="qf-stage"><?php esc_html_e( 'STAGE', 'energynet' ); ?></label>
					<select class="contact-form__select" id="qf-stage" name="qf_stage">
						<option value="" disabled selected><?php esc_html_e( 'Select project stage', 'energynet' ); ?></option>
				...
				<div class="contact-form__field">
					<label class="contact-form__label" for="qf-type"><?php esc_html_e( 'TYPE', 'energynet' ); ?></label>
					<select class="contact-form__select" id="qf-type" name="qf_type">
						<option value="" disabled selected><?php esc_html_e( 'Select project type', 'energynet' ); ?></option>
				...
				<label class="contact-form__checkbox-wrap">
					...
					<span class="contact-form__checkbox-label">
						<?php esc_html_e( 'I agree to the terms and conditions and privacy policy.', 'energynet' ); ?>
					</span>
				</label>
